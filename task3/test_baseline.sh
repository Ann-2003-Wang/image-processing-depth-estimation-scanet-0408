...
# 赋予脚本执行权限：chmod +x test_baseline.sh
# 运行：./test_baseline.sh

# ========== 配置参数 ==========
OUTPUT_DIR="/225040103/task3/baseline"   # 模型与结果存放目录
EPOCH_START=1
EPOCH_END=32
...
echo "全部测试完成！"
echo "结果文件位置:"
echo "   - 各 epoch 结果: ${OUTPUT_DIR}/val_results/epoch_*.json"
echo "   - 性能表格: ${OUTPUT_DIR}/val_results/performance.csv"
echo "   - 性能曲线: ${OUTPUT_DIR}/val_results/performance_curve.png"
echo "   - 可视化图片: ${OUTPUT_DIR}/visualizations/"
echo "=========================================="
